...
import WeatherPredictions from "@/components/WeatherPredictions";
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6" data-testid="page-dashboard">
      ...
      {/* Weather Predictions */}
      <div className="space-y-4">
        <h2 className="text-xl font-semibold">Weather Forecasting</h2>
        <WeatherPredictions location={cityData.location} />
      </div>
